...
WireSyncReturn wire_http_client_new(void);

WireSyncReturn wire_http_client_get(struct wire_HttpClient client,
                                    struct wire_uint_8_list *url,
                                    struct wire_Config *config);

WireSyncReturn wire_http_client_post(struct wire_HttpClient client,
                                     struct wire_uint_8_list *url,
                                     struct wire_uint_8_list *body,
                                     struct wire_Config *config);

WireSyncReturn wire_http_client_put(struct wire_HttpClient client,
                                    struct wire_uint_8_list *url,
                                    struct wire_uint_8_list *body,
                                    struct wire_Config *config);

WireSyncReturn wire_http_client_patch(struct wire_HttpClient client,
                                      struct wire_uint_8_list *url,
                                      struct wire_uint_8_list *body,
                                      struct wire_Config *config);

WireSyncReturn wire_http_client_delete(struct wire_HttpClient client,
                                       struct wire_uint_8_list *url,
                                       struct wire_Config *config);

WireSyncReturn wire_http_client_options(struct wire_HttpClient client,
                                        struct wire_uint_8_list *url,
                                        struct wire_Config *config);

WireSyncReturn wire_http_client_head(struct wire_HttpClient client,
                                     struct wire_uint_8_list *url,
                                     struct wire_Config *config);
...
void drop_opaque_HttpResponse(const void *ptr);

const void *share_opaque_HttpResponse(const void *ptr);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) drop_opaque_HttpResponse);
    dummy_var ^= ((int64_t) (void*) share_opaque_HttpResponse);
